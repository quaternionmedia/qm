...
|---|---|---|---|---|---|---|
| [awtkns/fastapi-crudrouter](https://github.com/awtkns/fastapi-crudrouter) (MIT) | [quaternionmedia/fastapi-crudrouter](https://github.com/quaternionmedia/fastapi-crudrouter) `motor-reupdate` — Motor/Beanie backend support | *none* | alfred | 2021-11-14 | `unoffered` | Surfaced by alfred's constitution adoption. Installed at build time via a `git+https` dependency in `pyproject.toml`. Carried since 2021-11-14; pinned to `motor-reupdate` since 2023-03-19. No pull request has ever been opened upstream by QM: checked across all of upstream's pull requests, none originate from a `quaternionmedia` head. Upstream is unarchived and MIT-licensed but has had no push since 2023-11-01. **A third party is already upstreaming this capability** — [awtkns/fastapi-crudrouter#199 "Beanie ODM support"](https://github.com/awtkns/fastapi-crudrouter/pull/199), open since 2024-11-10. That reframes the promote-or-drop decision: the contribution record's sponsorship clause covers paying for review bandwidth, and an open PR nobody is reviewing on a dormant upstream is precisely the case it describes. Reviewing or sponsoring #199 is a cheaper remediation than promoting a QM fork, and it serves the commons rather than forking away from it. |
