...
project's own dedicated branch (`project/frizzle`, created from `main`) -
...
- **frizzle adopts the QM constitution, and what that covers** — adoption and
  scope, with the conflict table and a walk of the eight org obligations.
